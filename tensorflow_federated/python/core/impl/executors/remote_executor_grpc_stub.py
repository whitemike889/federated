...
class RemoteExecutorGrpcStub(remote_executor_stub.RemoteExecutorStub):
  ...
  def create_value(
    ...
    """Invokes CreateValue remotely over gRPC.
  ...
  def create_struct(
    ...
    """Invokes CreateStruct remotely over gRPC.
  ...
  def create_call(
    ...
    """Invokes CreateCall remotely over gRPC.
  ...
  def create_selection(
    ...
    """Invokes CreateSelection remotely over gRPC.
  ...
  def compute(
    ...
    """Invokes Compute remotely over gRPC.
  ...
  def set_cardinalities(
    ...
    """Invokes SetCardinalities remotely over gRPC.
  ...
  def dispose(
    ...
    """Invokes Dispose remotely over gRPC.
  ...
  def clear_executor(
    ...
    """Invokes ClearExecutor remotely over gRPC.
  ...
  def is_ready(self) -> bool:
    """Returns true if gRPC connection is established."""
